...
export function Layout({ children }: LayoutProps) {
  ...
  const sidebarItems = [
    ...
    { href: "/members", label: "Membros", icon: Calendar },
    { href: "/families", label: "Famílias", icon: Users }, 
    { href: "/groups", label: "Grupos", icon: DollarSign },
    { href: "/ministries", label: "Ministerios", icon: Box },
    { href: "/finances", label: "finanças", icon: Scissors },
    {href: "/communication", label: "Comunicação", icon: FileClock},
    {href: "/volunteers", label: "voluntários", icon: UserLock},
    {href: "/inventory", label: "Patrimônio", icon: ShoppingBag},
    {href: "/checkin", label: "Check-in Eventos", icon: BellDot},
    {href: "/family-tree", label: "Árvore Genealógica", icon: BellDot},
